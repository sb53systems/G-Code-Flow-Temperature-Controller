...
Example below with my max 200mm/s Printer speed :       (Experimental approach)  
![image](https://github.com/user-attachments/assets/a4ca7c48-0c74-4015-809b-102f71577593)![image](https://github.com/user-attachments/assets/2aa450c6-984d-432c-890e-d0d0ada0d7a4)  
...
- PA can be regulated in the script according to the temperature or not to keep PA from the Slicer.  
...
If yes:  
The first time, Klipper_Estimator script requires a file containing the maximum limits of the printer (config .json), can be obtained by specifying the IP address of the printer or by choosing a file locally.  
...
if the printer is not the same you must change this file, then click the PROCEED button again.  
