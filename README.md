...
The visual calibration method (useful for PETG,PLA,...) involves choosing the desired appearance (closest to the original filament) over 3-5 prints: a Cylinder in Vase mode for higher flow rate (you can use the max Layer Height and max Line Width), and very small prints for (0 to 3)mm3/s (a 3DBenchy at 20/30 % Scale!).  
