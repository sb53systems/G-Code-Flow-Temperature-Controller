...
begin
  if form1.CheckBox1.Checked then series1.Transparency:=0 else series1.Transparency:=100;
  Chart1.Repaint;
end;
...
begin
  if form1.CheckBox3.Checked then series8.Transparency:=0 else series8.Transparency:=100;
  Chart1.Repaint;
end;

procedure TForm1.CheckBox2Click(Sender: TObject);
begin
  if form1.CheckBox2.Checked then series2.Transparency:=0 else series2.Transparency:=100;
  Chart1.Repaint;
end;

procedure TForm1.CheckBox5Click(Sender: TObject);
begin
  if form1.CheckBox5.Checked then series5.Transparency:=0 else series5.Transparency:=100;
  Chart1.Repaint;
end;

procedure TForm1.CheckBox4Click(Sender: TObject);
begin
  if form1.CheckBox4.Checked then series4.Transparency:=0 else series4.Transparency:=100;
  Chart1.Repaint;
end;
...
begin
  ...
  if gcodeProcces then begin
    ...
    Form1.BitBtn8.Caption:='Estimating';
